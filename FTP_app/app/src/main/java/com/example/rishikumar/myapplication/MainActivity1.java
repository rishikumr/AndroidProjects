package com.example.rishikumar.myapplication;
...
public class MainActivity1 extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnLoginFtp:
                if (isOnline(MainActivity1.this)) {
                    connectToFTPAddress();
                } else {
            ...
            case R.id.btnUploadFile:
                pd = ProgressDialog.show(MainActivity1.this, "", "Uploading...",
                        true, false);
            ...
            case R.id.btnDisconnectFtp:
                pd = ProgressDialog.show(MainActivity1.this, "", "Disconnecting...",
                        true, false);
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            if (msg.what == 0) {
                ...
                Toast.makeText(MainActivity1.this, "Uploaded Successfully!",
                        Toast.LENGTH_LONG).show();
            } else if (msg.what == 3) {
                Toast.makeText(MainActivity1.this, "Disconnected Successfully!",
                        Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(MainActivity1.this, "Unable to Perform Action!",
                        Toast.LENGTH_LONG).show();
            }
    ...
    private void connectToFTPAddress() {
        ...
        if (host.length() < 1) {
            Toast.makeText(MainActivity1.this, "Please Enter Host Address!",
                    Toast.LENGTH_LONG).show();
        } else if (username.length() < 1) {
            Toast.makeText(MainActivity1.this, "Please Enter User Name!",
                    Toast.LENGTH_LONG).show();
        } else if (password.length() < 1) {
            Toast.makeText(MainActivity1.this, "Please Enter Password!",
                    Toast.LENGTH_LONG).show();
        } else {

            pd = ProgressDialog.show(MainActivity1.this, "", "Connecting...",
                    true, false);
    ...
    private void getFTPFileList() {
        pd = ProgressDialog.show(MainActivity1.this, "", "Getting Files...",
                true, false);
