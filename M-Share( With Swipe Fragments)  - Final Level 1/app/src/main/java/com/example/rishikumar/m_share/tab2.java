...
public class tab2 extends Fragment implements View.OnClickListener {
    ...
    public void onStop() {
       ...
       /* ed1.putString("title", tv12.getText().toString());
        ed1.putString("album", tv22.getText().toString());
        ed1.putString("artist", tv32.getText().toString());*/

        ed1.commit();
        // Log.d("taggg", "frag 2 is destroyed and i put ispressed as :" + !isPressed);
