 ...
 */
public class EventDetailedFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        event_name = requireActivity().findViewById(R.id.event_name_full_detail_page);
        event_location = requireActivity().findViewById(R.id.event_location_full_detail_page);
        event_date = requireActivity().findViewById(R.id.event_date_full_detail_page);
        event_description = requireActivity().findViewById(R.id.event_description_full_detail_page);
        wormDotsIndicator = (WormDotsIndicator) requireActivity().findViewById(R.id.worm_dots_indicator_full_detail_page);
        editEventButton = requireActivity().findViewById(R.id.edit_mode_full_detailed_page);
        deleteEventButton = requireActivity().findViewById(R.id.delete_event_full_detailed_page);
        mViewModel = new ViewModelProvider(this).get(EventViewModel.class);
        navController = Navigation.findNavController(requireActivity(), R.id.nav_host_fragment);

        if (getArguments() != null) {
           event_Id = getArguments().getInt("mEventId");
        }
        try {
        ...
        viewPage = requireActivity().findViewById(R.id.imageViewPager_detailed_page);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.edit_mode_full_detailed_page:
                ...
                navController.navigate(R.id.action_eventDetailedFragment_to_editEventFragment, mBundle);
                break;
                ...
                builder1.setPositiveButton(
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                navController.navigate(R.id.action_eventDetailedFragment_to_eventHomeScreenFragment);
                            }
                        });
