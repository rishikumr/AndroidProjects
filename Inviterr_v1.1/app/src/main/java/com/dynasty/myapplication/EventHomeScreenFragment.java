 ...
 * Use the {@link EventHomeScreenFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class EventHomeScreenFragment extends Fragment {
    ...
    public EventHomeScreenFragment() {
    ...
    public static EventHomeScreenFragment newInstance(String param1, String param2) {
        EventHomeScreenFragment fragment = new EventHomeScreenFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        addButton = requireActivity().findViewById(R.id.floatingAddButton);
        addButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                navController.navigate(R.id.action_eventHomeScreenFragment_to_editEventFragment);
            }
        });
        ...
        recyclerView = requireActivity().findViewById(R.id.eventsScrollView);
        ...
        adaptor.setOnEventClickListener(new EventScrollViewAdaptor.OnEventClickListener() {
            ...
            public void onItemClick(Event ev , int position) {
              //  Log.d(TAG, "on Event Clicked  ev.getID()=" + ev.getId()  + "position  ="+ position);
                ...
                mBundle.putInt("mEventId",ev.getId());
                navController.navigate(R.id.action_eventHomeScreenFragment_to_eventDetailedFragment, mBundle);
