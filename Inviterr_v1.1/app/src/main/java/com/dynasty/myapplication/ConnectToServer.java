...
public class ConnectToServer  {
    ...
    protected  void doLogIn(String mUsername, String mPassword, Context cx) {
    ...
    protected void doGetOTP(String mMobileNumber , String mUserIpAddress , Context cx) {
    ...
    protected void doSignUp (String mMobileNumber, String mPassword  , String mOTP , String mUserIpAddress , Context cx) {
    ...
    protected  void doDelete(String mPhoneNumber, Context cx) {
        RequestQueue requestQueue = Volley.newRequestQueue(cx);
        JSONObject payload = new JSONObject();
        try {
    ...
    protected  void doGetUser(final String mToken, Context cx) {
